...
// https://registry.terraform.io/providers/integrations/github/6.11.1/docs/resources/repository_dependabot_security_updates
...
export interface RepositoryDependabotSecurityUpdatesConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class RepositoryDependabotSecurityUpdates extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RepositoryDependabotSecurityUpdates that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/resources/repository_dependabot_security_updates#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "github_repository_dependabot_security_updates", importId: importFromId, provider });
      }
