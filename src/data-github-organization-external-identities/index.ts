...
// https://registry.terraform.io/providers/integrations/github/6.11.1/docs/data-sources/organization_external_identities
...
export class DataGithubOrganizationExternalIdentitiesIdentitiesOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  private _samlIdentity = new cdktn.StringMap(this, "saml_identity");
  public get samlIdentity() {
    return this._samlIdentity;
  }

  // scim_identity - computed: true, optional: false, required: false
  private _scimIdentity = new cdktn.StringMap(this, "scim_identity");
  public get scimIdentity() {
    return this._scimIdentity;
  }
}

export class DataGithubOrganizationExternalIdentitiesIdentitiesList extends cdktn.ComplexList {
...
export class DataGithubOrganizationExternalIdentities extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGithubOrganizationExternalIdentities that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/data-sources/organization_external_identities#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "github_organization_external_identities", importId: importFromId, provider });
      }
