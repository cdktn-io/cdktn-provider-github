...
// https://registry.terraform.io/providers/integrations/github/6.11.1/docs/resources/enterprise_actions_runner_group
...
export interface EnterpriseActionsRunnerGroupConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class EnterpriseActionsRunnerGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EnterpriseActionsRunnerGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/resources/enterprise_actions_runner_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "github_enterprise_actions_runner_group", importId: importFromId, provider });
      }
  ...
  */
  ...
  public get selectedOrganizationIds() {
    return cdktn.Token.asNumberList(cdktn.Fn.tolist(this.getNumberListAttribute('selected_organization_ids')));
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      selected_organization_ids: cdktn.listMapper(cdktn.numberToTerraform, false)(this._selectedOrganizationIds),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      selected_organization_ids: {
        value: cdktn.listMapperHcl(cdktn.numberToHclTerraform, false)(this._selectedOrganizationIds),
        isBlock: false,
        type: "set",
