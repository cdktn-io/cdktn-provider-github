...
// https://registry.terraform.io/providers/integrations/github/6.11.1/docs/resources/branch
...
export class Branch extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Branch that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/resources/branch#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the Branch to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "github_branch", importId: importFromId, provider });
      }
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      source_branch: cdktn.stringToTerraform(this._sourceBranch),
      source_sha: cdktn.stringToTerraform(this._sourceSha),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      source_branch: {
        value: cdktn.stringToHclTerraform(this._sourceBranch),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      source_sha: {
        value: cdktn.stringToHclTerraform(this._sourceSha),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
