...
// https://registry.terraform.io/providers/integrations/github/6.11.1/docs/data-sources/issue_labels
...
export class DataGithubIssueLabelsLabelsOutputReference extends cdktn.ComplexObject {
...
export class DataGithubIssueLabelsLabelsList extends cdktn.ComplexList {
...
export class DataGithubIssueLabels extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGithubIssueLabels that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/data-sources/issue_labels#import import section} in the documentation of this resource for the id to use
