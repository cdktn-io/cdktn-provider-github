...
// https://registry.terraform.io/providers/integrations/github/6.11.1/docs/data-sources/organization_repository_roles
...
export class DataGithubOrganizationRepositoryRolesRolesOutputReference extends cdktn.ComplexObject {
...
export class DataGithubOrganizationRepositoryRolesRolesList extends cdktn.ComplexList {
...
export class DataGithubOrganizationRepositoryRoles extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGithubOrganizationRepositoryRoles that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/data-sources/organization_repository_roles#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "github_organization_repository_roles", importId: importFromId, provider });
      }
