...
// https://registry.terraform.io/providers/integrations/github/6.11.1/docs/resources/actions_organization_secret
...
export class ActionsOrganizationSecret extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ActionsOrganizationSecret that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/resources/actions_organization_secret#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "github_actions_organization_secret", importId: importFromId, provider });
      }
  ...
  */
  ...
  private _destroyOnDrift?: boolean | cdktn.IResolvable; 
  public get destroyOnDrift() {
    return this.getBooleanAttribute('destroy_on_drift');
  }
  public set destroyOnDrift(value: boolean | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      destroy_on_drift: cdktn.booleanToTerraform(this._destroyOnDrift),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      destroy_on_drift: {
        value: cdktn.booleanToHclTerraform(this._destroyOnDrift),
        isBlock: false,
        type: "simple",
