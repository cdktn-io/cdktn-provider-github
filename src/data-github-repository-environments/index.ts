...
export class DataGithubRepositoryEnvironmentsEnvironmentsOutputReference extends cdktn.ComplexObject {
...
export class DataGithubRepositoryEnvironmentsEnvironmentsList extends cdktn.ComplexList {
...
export class DataGithubRepositoryEnvironments extends cdktn.TerraformDataSource {
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "github_repository_environments", importId: importFromId, provider });
      }
