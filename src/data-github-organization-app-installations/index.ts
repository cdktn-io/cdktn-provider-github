...
export class DataGithubOrganizationAppInstallationsInstallationsOutputReference extends cdktn.ComplexObject {
...
export class DataGithubOrganizationAppInstallationsInstallationsList extends cdktn.ComplexList {
...
export class DataGithubOrganizationAppInstallations extends cdktn.TerraformDataSource {
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "github_organization_app_installations", importId: importFromId, provider });
      }
