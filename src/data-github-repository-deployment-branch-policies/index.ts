...
// https://registry.terraform.io/providers/integrations/github/6.11.1/docs/data-sources/repository_deployment_branch_policies
...
export interface DataGithubRepositoryDeploymentBranchPoliciesConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataGithubRepositoryDeploymentBranchPoliciesDeploymentBranchPoliciesOutputReference extends cdktn.ComplexObject {
...
export class DataGithubRepositoryDeploymentBranchPoliciesDeploymentBranchPoliciesList extends cdktn.ComplexList {
...
export class DataGithubRepositoryDeploymentBranchPolicies extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGithubRepositoryDeploymentBranchPolicies that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/data-sources/repository_deployment_branch_policies#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "github_repository_deployment_branch_policies", importId: importFromId, provider });
      }
