...
// https://registry.terraform.io/providers/integrations/github/6.11.1/docs/data-sources/dependabot_secrets
...
export class DataGithubDependabotSecretsSecretsOutputReference extends cdktn.ComplexObject {
...
export class DataGithubDependabotSecretsSecretsList extends cdktn.ComplexList {
...
export class DataGithubDependabotSecrets extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGithubDependabotSecrets that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/data-sources/dependabot_secrets#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "github_dependabot_secrets", importId: importFromId, provider });
      }
