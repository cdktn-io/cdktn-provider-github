...
// https://registry.terraform.io/providers/integrations/github/6.11.1/docs/resources/organization_repository_role
...
export interface OrganizationRepositoryRoleConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class OrganizationRepositoryRole extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationRepositoryRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.11.1/docs/resources/organization_repository_role#import import section} in the documentation of this resource for the id to use
